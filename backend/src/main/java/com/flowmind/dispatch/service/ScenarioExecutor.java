...
public class ScenarioExecutor {
    ...
    public DispatchResponse execute(IntentType intent, SessionContext sessionContext) {
        ...
        return switch (intent) {
            case ACCOUNT_INFO_INQUIRY -> new DispatchResponse(
                    RouteType.SCENARIO,
                    intent,
            ...
            case TRANSACTION_HISTORY_INQUIRY -> new DispatchResponse(
                    RouteType.SCENARIO,
                    intent,
            ...
            case CARD_LOST_OR_LIMIT -> new DispatchResponse(
                    RouteType.SCENARIO,
                    intent,
            ...
            case UNKNOWN -> new DispatchResponse(
                    RouteType.LLM,
                    intent,
                    "요청을 명확히 파악하지 못했습니다.",
                    "FALLBACK",
